...
# ISLM model- Keynesian Assumptions
...
# According to the World Bank, the US GDP may contract by 3.4%. 
#Our model of contraction due to Corona Virus, COVID19, predicts
#contraction of between 8 and 15%.  AlsoAssume 12% contraction
