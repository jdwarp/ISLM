...
1. find values of Tax and g_sPend the result in interestRate  around 
1% Using IS
...
2. using interest rate from IS above,   
change mOp to match intR
...
policy recommendations are made by the ISLM model?
