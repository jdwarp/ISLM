...
For this exercise assume Full Employment GDP is $21700B, and Nx = -500
 ...
 1. Given the last values of the variables, (estimates of current US       macroeconomic values), what is the equilibrium level of GDP predicted by IS_Y?
 

 2. Policy- the COVID19 virus will likely reduce GDP  by 1 or 2 % and
    change Nx by about 5% or more (we import less).  Given this,
...
2a. find values of Tax and g_Spend the result in interestRate  around 
1% Using IS
...
Tax = 2010  # tax cut??
g_Spend = 7600  # increase government spending? usually happens in an 
                #  election year
...
2b. Using interest rate from IS above, find money supply (mOp) to match equilibIntRate
